...
int main()
{
    ...
    printf("Welcome to Data Structure Application Written by Rohan Hanumant Chavan \n");
    while(1)
    {
        printf("-------------------------------------------------------------------------------------\n");
        ...
        printf(" 8: Count All Number of Node from Linked List \n");
        

         printf(" 9: End the Linked List Application \n");
         ...
         switch(iChoice)
         {
            ...
            case 8:
            iRet = Count(Head);
            printf("Count of Linked List Element is : %d\n",iRet);
            break;
